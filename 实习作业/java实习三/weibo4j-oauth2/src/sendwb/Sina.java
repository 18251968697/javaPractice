...
public class Sina {  
    ...
    public static void sendout(String id, String pw, String cst){
    	 
        try {
        	AccessToken at = getToken(id, pw); 
			sinaSendWeibo(at.getAccessToken(),cst);
		} catch (Exception e) {e.printStackTrace();}
    }
  
    public static void main(String[] args) throws Exception  
    {  
        AccessToken at = getToken("yy971914033@sina.cn","971914033");  
        sinaSendWeibo(at.getAccessToken(),"杨源是傻逼");  
    }  
}  