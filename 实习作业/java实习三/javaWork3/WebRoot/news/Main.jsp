...
ul.nav a, ul.nav a:visited { /* 对这些选择器进行分组可确保链接即使在访问之后也能保持其按钮外观 */
	padding: 40px 30px 40px 30px;  /*上右下左*/
	display: block; /* 这将为链接赋予块属性，使其填满包含它的整个 LI。这样，整个区域都可以响应鼠标单击操作。 */
	text-decoration: none;
	background-color: #8090AB;
	color: #000;
}
ul.nav a:hover, ul.nav a:active, ul.nav a:focus { /* 这将更改鼠标和键盘导航的背景和文本颜色    鼠标或键盘触碰时改变的颜色*/
	background-color: #6F7D94;
	color: #FFF;
}
...
<div class="container">
  <div class="header">
  	<a href="#"><img src="image/ifttt_logo.png" alt="在此处插入徽标" name="Insert_logo" width="20%" height="180" id="Insert_logo" style="background-color: #8090AB; display:block;" /></a>
     
    <!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
    
      <li><a href="Login.jsp" target="_parent">主页/公告</a></li>
      <li><a href="Login.jsp" target="_top">个人信息</a></li>
      <li><a href="Login.jsp" target="_blank">会员中心</a></li>
      <li><a href="Login.jsp" target="_self">任务管理</a></li>
    </ul>
