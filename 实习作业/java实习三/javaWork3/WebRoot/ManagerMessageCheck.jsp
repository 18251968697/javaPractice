...
<%	str = request.getParameter("delete");
	if(str!=null&&str.equals("删   除")){
		postId = request.getParameter("postId");
		sql.deletePost(Integer.parseInt(postId));
		response.sendRedirect("ManagerMain.jsp");
		return;
	}
%>
<%	str = request.getParameter("alter");
	if(str!=null&&str.equals("修   改")){
		postId = request.getParameter("postId");
		response.sendRedirect("ManagerMessageEdit.jsp?postId="+postId);
		return;
	}
%>
...
<div class="header">
  ...
  <div class="sidebar1">
    <ul>
      <a href="MessagerMain.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('首页公告','','image/buttoned1.png',1)"><img src="image/buttoned1.png" alt="首页公告" width="100%" height="100" id="首页公告" /></a>
      ...
      <a href="TaskMessage.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('任务管理','','image/buttoned4.png',1)"><img src="image/button4.png" alt="任务管理" width="100%" height="100" id="任务管理" /></a>
    </ul>
...
<%	out.print(postCst);%>
    ...
    <p>&nbsp;</p>
    <form name="ManagerMessageCheck" method="post" action="">
    <p align="center">
                <input type="submit" name="alter" id="alter" value="修   改">
                &nbsp; &nbsp;&nbsp; &nbsp; 
                <input type="submit" name="delete" id="delete" value="删   除">
    </p>
