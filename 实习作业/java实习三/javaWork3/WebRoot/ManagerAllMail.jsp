  ...
  <div class="content" >
    ...
    <h2>所有站内信：</h2>
     <table align="center" width="80%" border="1" cellspacing="1" cellpadding="1" background="image/tableBackground.png">
      <tr class="Label3" align="center">
      	<td width="15%">发信人</td><td width="15%">收信人</td>
        <td width="20%">日期</td>
        <td width="40%">标题</td>
        <td width="10%">操作</td>
      </tr>
	<%	rs=sql.queryMail();
    	while(rs.next()){
    		...
    		out.print("<tr><td align=center>"+from+"</td><td align=center>"+to+"</td><td align=center>"+date+"</td><td ><a href=ManagerMailCheck.jsp?mailId="+Integer.toString(mailId)
    		+">"+title+"</a></td><td align=center><a href=ManagerMail.jsp?delete=true&&mailId="+mailId+">删 除</a></td></tr>");
    	}
     %>
    </table>
    <p>&nbsp; </p>
    <p>&nbsp; </p>
  	  ...
  	  <tr>
    	<td><a href="ManagerMailCreate.jsp" target="_self">发送站内信</a></td></tr>
