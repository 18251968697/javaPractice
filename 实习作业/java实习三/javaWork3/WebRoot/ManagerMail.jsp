  ...
  <div class="content" >
	...
	<%	rs=sql.queryMail(userId);
    	while(rs.next()){
    		...
    		out.print("<tr><td align=center>"+date+"</td><td ><a href=ManagerMailCheck.jsp?mailId="+Integer.toString(mailId)
    ...
    <p>&nbsp; </p>
    	...
    	<tr>
    	<td><a href="ManagerAllMail.jsp" target="_self">查看所有信件</a></td></tr>
    </table>
<p>&nbsp;</p>
