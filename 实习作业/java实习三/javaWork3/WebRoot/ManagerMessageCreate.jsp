...
<%	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	...
	str = request.getParameter("createAPost");
	if(str!=null && str.equals("发   布")){
		String postTitle = request.getParameter("messageTitle");
		String postCst = request.getParameter("textarea");
		sql.sendPost(postTitle, postCst);
...
<div class="header">
  ...
  <table width="100%" height="75" border="0">
    ...
    <h2>发布系统公告：</h2>
    <p>&nbsp;</p>
    <form name="ManagerMessageCreate" method="post" action="ManagerMessageCreate.jsp">
    <table width="700px" height="300px" align="center" border="2" cellpadding="2" cellspacing="2">
      <tr>
        ...
        <td width="90%" height="30" class="Label3">
        	日期：
            <input type="text" size=50 name="messageDate" id="messageDate" value=<%=postDate %> />
        </td>
      </tr>
      <tr>
        <td height="30" class="Label3">
            ...
            <input name="messageTitle" type="text" id="messageTitle" size="50" />
    ...
    <p>&nbsp;</p>
    <p align="center">
                <input type="submit" name="createAPost" id="submit" value="发   布">
                &nbsp; &nbsp;&nbsp; &nbsp; 
