...
<% 	String mailId = request.getParameter("mailId");
	...
	String mailDate="", mailTitle="", mailCst="", fromAddr="";
	if(mailId!=null&&!mailId.equals("")){
		rs = sql.queryMailByMailId(Integer.parseInt(mailId));
		if(rs.next()){
			mailTitle = rs.getString(4).trim();
			mailCst = rs.getString(5).trim();
			mailDate = rs.getString(6).trim();
			fromAddr = rs.getString(3).trim();
		}	
	}
%>
...
<%	out.print(mailCst);%>
	...
	<table cellspacing="10" class="fix">
    	  <td><a href="ManagerMail.jsp" title="返回公告首页" target="_self">返回站内信首页</a></td>
    </table>
    <p>&nbsp;</p>
